...
data = [["gs1", "gs2", "scaled_pop_product", "scaled_dist"]]
...
for gs1, gs2 in gs_pairs:
  ...
  # print(f"{gs1['name']} {gs2['name']} {scaled_pop_product} {scaled_dist}")
  data.append([gs1['id'], gs2['id'], scaled_pop_product, scaled_dist])
